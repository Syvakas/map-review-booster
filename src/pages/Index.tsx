        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <div className="py-8">
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              {/* Feature Card 1 */}
              <div className="group bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-100 rounded-2xl p-8 text-center hover:shadow-xl hover:scale-105 transition-all duration-300">
              ...
              {/* Feature Card 2 */}
              <div className="group bg-gradient-to-br from-emerald-50 to-teal-50 border border-emerald-100 rounded-2xl p-8 text-center hover:shadow-xl hover:scale-105 transition-all duration-300">
              ...
              {/* Feature Card 3 */}
              <div className="group bg-gradient-to-br from-purple-50 to-pink-50 border border-purple-100 rounded-2xl p-8 text-center hover:shadow-xl hover:scale-105 transition-all duration-300">
